...
function buildPrompt(input: {
  ...
  return [
    ...
    '若研究目的涉及A股投资，必须按产业链关键生态位建立“候选公司覆盖台账”：区分链主、设备、材料、封测、模组/渠道和终端等实际适用环节；每个关键受益环节尽量检索至少3家可比A股公司，并逐家公司搜索年报、公告或主营构成等可验证资料。',
    '不得用一家已找到公告的公司代替整个A股候选池，也不得从概念股名单倒推产业逻辑。证据不足的公司仍可作为“待核验线索”列出，但必须说明所属生态位、待核验业务暴露和缺失来源，并对每个未覆盖环节给出原因。',
